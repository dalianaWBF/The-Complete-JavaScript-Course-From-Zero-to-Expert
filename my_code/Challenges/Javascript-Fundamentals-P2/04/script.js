...
/*
Let's improve Steven's tip calculator even more, this time 
using loops!
...
Your tasks:
    ...
    Bonus:
        ...
        array. This is a difficult challenge (we haven't 
        done this before)! Here is how to solve it:
            4.1. First, you will need to add up all values in 
            the array. To do the addition, start by creating a 
            variable 'sum' that starts at 0. Then loop over 
            the array using a for loop. In each iteration, add 
            the current value to the 'sum' variable. This way, 
...
const billTestData = [22, 295, 176, 440, 37, 105, 10, 1100, 86, 52];
const tipsArray = [];
const billAndTips = [];
const totalBonus = [];
let sum = 0;
...
console.log('Bills: \n');
console.log(billTestData);
console.log('Total (tip + bill): \n');
console.log(billAndTips);

console.log('Total bonus exercise - average of an array: \n');
console.log(calcAverage(billTestData));