...
const startLogOutTimer = function () {
  //hacer que el timer se ejecute inmediatamente
  const tick = function () {
    ...
    if (time === 0) {
      ...
      containerApp.style.opacity = 0; //hacer visible el contenido
    }
  ...
  //stop a timer for users if other is logout before the timer stops
  return timer;
};
