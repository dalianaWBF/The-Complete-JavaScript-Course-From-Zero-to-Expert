...
Your tasks:
    ...
    a variable called 'tip' for this. It's not allowed to use 
    an if/else statement 😅 (If it's easier for you, you can 
...
Test data:
    ...
    Hints:
    - To calculate 20% of a value, simply multiply it by 
    20/100 = 0.2 
